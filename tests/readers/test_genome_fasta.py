...
def variable_bed():
    ...
    variable_bed = pd.read_csv(variable_bed, sep="\t", header=None, names=["chrom", "chromStart", "chromEnd"])
    return variable_bed
...
def fixed_bed():
    ...
    fixed_bed = pd.read_csv(fixed_bed, sep="\t", header=None, names=["chrom", "chromStart", "chromEnd"])
    return fixed_bed
...
def test_from_region_files(
    ...
    with (
        ...
        bed = pd.read_csv(variable_bed, sep="\t", header=None, names=["chrom", "chromStart", "chromEnd"])
